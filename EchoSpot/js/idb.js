// Minimal IndexedDB wrapper with a single object store: echoes
const DB_NAME = 'echospot-db';
const DB_VERSION = 1;
const STORE = 'echoes';
...
export async function putEcho(echo) {
  await withStore('readwrite', (store) => store.put(echo));
  return echo;
}
